    ...
    >
      <div className="max-w-xl rounded-xl border border-ink-700 bg-ink-800 p-8 text-center shadow-2xl">
        ...
        <p className="mb-6 text-sm text-ink-300">
          {mode === 'pathogen' ? 'Pathogen' : 'Defender'} mode — Day {day}
        </p>
        <dl className="mb-6 grid grid-cols-2 gap-2 text-left font-mono text-sm">
          ...
          <Item label="Countries detected" value={`${detected}`} />
